...
export const AI_AND_GENERATIVE_AI_FUNDAMENTALS_FOR_DATA_SCIENTISTS_CHAPTERS: ChapterMeta[] = [
  {
    ...
    lessons: [
      ...
      L(5, "when-neural-networks-beat-classical-ml", "When Neural Networks Beat Classical ML", { contentDir: "ch01/05-when-neural-networks-beat-classical-ml" }),
    ],
  },
  {
    n: 2,
    ...
    lessons: [
      L(6, "sequence-models-and-attention", "Sequence Models & Attention", { contentDir: "ch02/06-sequence-models-and-attention" }),
      L(7, "the-transformer-architecture", "The Transformer Architecture", { contentDir: "ch02/07-the-transformer-architecture" }),
      L(8, "how-llms-are-trained", "How LLMs Are Trained", { contentDir: "ch02/08-how-llms-are-trained" }),
