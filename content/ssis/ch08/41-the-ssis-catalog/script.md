# Script — The SSIS Catalog

## Segment 1 (title)

Welcome to Chapter 8 — Deployment and Administration. Everything up to
this point has lived inside SSDT, on your own machine. Starting now, we
...
Server — it's a real database, named SSISDB, sitting inside a normal
instance of the SQL Server Database Engine, with its own node,
Integration Services Catalogs, in Object Explorer. Once it exists, this
is the single place every deployed project, its parameters, its
environments, and its entire execution history all live — everything
...
database master key SSISDB uses to encrypt sensitive values, like
connection strings and secrets — save it somewhere safe, because you
