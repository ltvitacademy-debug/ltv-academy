# Script — Report Caching & Snapshots

## Segment 1 (title)

Every report you build has to pick one of three ways to execute — and picking the wrong one either burns your data source with redundant queries, or shows people stale data without you realizing it. Let's sort out caching from snapshots, because they solve genuinely different problems.

## Segment 2 (steps: three execution modes)
