# Script — Formatting Numbers, Dates & Currency

## Segment 1 (title)

We closed out the last lesson looking at currency formatting in passing — let's go deep on it now, along with dates, and where all of it actually comes from.

## Segment 2 (screenshot: date-format-number-group)
